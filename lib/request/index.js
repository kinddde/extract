...
function _objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = _objectWithoutPropertiesLoose(source, excluded); var key, i; if (_getOwnPropertySymbols["default"]) { var sourceSymbolKeys = (0, _getOwnPropertySymbols["default"])(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if ((0, _indexOf["default"])(excluded).call(excluded, key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }

function _objectWithoutPropertiesLoose(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = (0, _keys["default"])(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if ((0, _indexOf["default"])(excluded).call(excluded, key) >= 0) continue; target[key] = source[key]; } return target; }
...
function () {
  function Request() {
    ...
    var logger = option.logger,
        param = _objectWithoutProperties(option, ["logger"]);
  ...
  _createClass(Request, [{
    ...
    value: function post() {
      if (this.$paramType === "form") {
        ...
        this.$data = (0, _stringify["default"])(this.$param);
      } else {
    ...
    value: function request() {
      ...
      return (0, _request2["default"])(this.$url, _objectSpread({
        method: this.$method,
        body: this.$data,
        headers: _objectSpread({}, this.reuqestParam ? this.reuqestParam.headers || {} : {})
      }, this.$option)).then(function (res) {
        return res.text();
      }).then(function (res) {
